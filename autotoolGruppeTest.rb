      ...
      mitSemester schule['UNr'], ->(semester) {
        mitVorlesung semester['ENr'], schule['UNr'], ->(vorlesung) {
          ensureTutor schule, vorlesung, student, ->() {
            gruppeAnlegenGui(vorlesung, semester, schule, name, maxStudenten, referent)
          }
        }
      }
    }
      ...
      mitSemester schule['UNr'], ->(semester) {
        mitVorlesung semester['ENr'], schule['UNr'], ->(vorlesung) {
          mitGruppe vorlesung['VNr'], ->(gruppe) {
            ensureTutor schule, vorlesung, student, ->() {
              gruppeBearbeitenGui(gruppe, vorlesung, semester, schule, name, maxStudenten, referent)
            }
          }
        }
      }
    ...
    mitSchuleAccount ->(schule, student) {
      mitSemester schule['UNr'], ->(semester) {
        mitVorlesung semester['ENr'], schule['UNr'], ->(vorlesung) {
          mitGruppe vorlesung['VNr'], ->(gruppe) {
            ensureTutor schule, vorlesung, student, ->() {
              gruppeEntfernenGui(gruppe, vorlesung, semester, schule)
            }
          }
        }
      }
